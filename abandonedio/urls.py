...
urlpatterns = patterns('',
                       ...
                       url(r'^projects/$', abandoned.views.projects_view, name='projects-alphabetical'),
                       url(r'^projects/(?P<sorting>\w+)/$', abandoned.views.projects_view),
                       url(r'^languages/$', abandoned.views.languages_view, name='languages-alphabetical'),
                       url(r'^languages/(?P<sorting>\w+)/$', abandoned.views.languages_view),
                       url(r'^tags/$', abandoned.views.tags_view, name='tags-alphabetical'),
                       url(r'^tags/(?P<sorting>\w+)/$', abandoned.views.tags_view),
                       url(r'^authors/$', abandoned.views.authors_view, name='authors-alphabetical'),
                       url(r'^authors/(?P<sorting>\w+)/$', abandoned.views.authors_view),
